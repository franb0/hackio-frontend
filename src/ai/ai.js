...
// Added dataset declaration
const fixedDataset = ["fixed_word1", "fixed_word2", "fixed_sentence1", "fixed_sentence2"];
...
function setup() {
    ...
    document.getElementById('train')
        .addEventListener('click', async() => {
            // Combine fixed dataset with dynamically loaded data
            const combinedDataset = [...fixedDataset, ...words];
            ...
            try {
                filtered_words = preprocessing_stage_1(combinedDataset, max_len);
